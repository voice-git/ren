...
<script>
	$(document).ready(function() {
		$(".btn_wrap .employee").click(function() {
			$(".btn_wrap .block").removeClass("active");
			$(this).addClass("active");
			$(".employee_content").addClass("active");
			$(".parttime_content").removeClass("active");
		});
		$(".btn_wrap .parttime").click(function() {
			$(".btn_wrap .block").removeClass("active");
			$(this).addClass("active");
			$(".employee_content").removeClass("active");
			$(".parttime_content").addClass("active");
		});
	});
</script>
<?php endif; ?>
